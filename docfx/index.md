...
**TreeDataGrid** is an Avalonia control for tabular and hierarchical data in a single view. It combines DataGrid-style columns with tree expansion behavior.

## Start Here

- [Getting Started Overview](articles/getting-started/overview.md)
- [Installation](articles/getting-started/installation.md)
- [Quickstart (Flat)](articles/getting-started/quickstart-flat.md)
- [Quickstart (Hierarchical)](articles/getting-started/quickstart-hierarchical.md)
...
- [Reference](articles/reference/api-coverage-index.md)
